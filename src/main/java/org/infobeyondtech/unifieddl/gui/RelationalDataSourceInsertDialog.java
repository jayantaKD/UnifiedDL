...
public class RelationalDataSourceInsertDialog extends InfobeyondDefaultInputDialog {
    ...
    public RelationalDataSourceInsertDialog(Frame baseFrame,JTree projectTree, DefaultMutableTreeNode originatorNode) {
        super(baseFrame, "OK","Relational Data Source Input");
    ...
    private void init(){
        addButton.addActionListener(new AddRelationalDataSourceAction());
        buildComponent();
    }
    ...
    protected String initTitleBorder() {
        return "Relational Data Source";
    }


    private class AddRelationalDataSourceAction implements ActionListener {
        @Override
        public void actionPerformed(ActionEvent e) {
            System.out.println("Adding relational data source ...");
            ProjectTreeObject rDataSource = new ProjectTreeObject(ProjectTreeObjectType.RELATIONAL_DATA_SOURCE,sourceNameField.getText());
            ...
            try {
                ...
                System.out.println("Error adding relational data");
